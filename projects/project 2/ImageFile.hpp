...
public:
    ...
    */
    ImageFile(const std::string& filename, const std::vector<std::vector<Pixel>>& pixels = std::vector<std::vector<Pixel>>(10, std::vector<Pixel>(20, {0,0,0})), bool readable = true, bool writable = true);
