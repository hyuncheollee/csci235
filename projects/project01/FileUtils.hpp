...
std::string findFileExtension(const std::string& filename);     // retrieves the file extension
bool hasWhitespaces(const std::string& filename);               // checks if the file name contains whitespaces
