...
public:
    ...
    /**
     * @brief Overloads (ie. adds the functionality) to use the "<<""
     * operator for printing out the file's string representation.
     *
     * @return A reference to the stream to which the file's string representation
     * has been added.
     */
